...
def wa():
    os.system('xdg-open https://api.whatsapp.com/send?phone=628882091584&text=Assalamualaikum')
...
def lodhirt():
    lodhirt = [
     'PAJAOQ', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'PAJAOQ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER', '      ', 'FAJAR CYBER\n']
    for o in lodhirt:
